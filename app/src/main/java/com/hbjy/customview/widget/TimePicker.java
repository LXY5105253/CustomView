package com.hbjy.customview.widget;
...
import com.hbjy.customview.R;
import com.hbjy.wheelpicker.OnWheelChangedListener;
import com.hbjy.wheelpicker.WheelView;
import com.hbjy.wheelpicker.adapter.ArrayWheelAdapter;
...
//        mViewDuration= (WheelView) popView.findViewById(R.id.wheel_duration);
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
			popWindow.setWindowLayoutType(WindowManager.LayoutParams.TYPE_SYSTEM_OVERLAY);
		}
